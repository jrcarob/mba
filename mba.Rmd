---
title: "Técnicas Estadísticas Aplicadas a la Gestión de Empresas (MBA 2023-2024)"
author: "Profesora María de los Baños García-Moreno García"
output: rmdformats::readthedown
---
## Contacto

#### Coordinadora y Profesora: 
#### _Dra. María de los Baños García-Moreno García_

**Despacho:** Área de Estadística, Econometría e Investigación Operativa, 1era Planta.</br> 
...
<!--- Cualquier otro día y hora previa consulta para disponibilidad.--->
...
**Lugar:** Seminario y Sala de Másteres 1 - Facultad de Derecho y CC Económicas y Empresariales

* Se ha organizado el curso en los siguientes módulos semanales.

```{r table2, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "  ### Calendario de Fechas
| Semana I      | Lunes, 18 diciembre | 18:00-20:00  |
|---------------|:-------------:|------:|
| | Miércoles, 20 diciembre        | 18:00-20:00  |
| **Semana II**       | **Lunes, 8 enero**        | **18:00-20:00**  |
| | Jueves, 11 enero        | 18:00-20:00  |
| **Semana III**       | **Martes, 16 enero**        | **18:00-20:00**  |
| | Jueves, 18 enero        | 18:00-20:00  |
| **Semana IV**       | **Martes, 23 enero**        | **18:00-20:00**  |
| | Jueves, 25 enero        | 18:00-20:00  |
| **Semana V**       | **Martes, 30 enero**        | **18:00-20:00**  |
| | Jueves, 1 febrero        | 18:00-20:00  |
| **Semana VI**       | **Martes, 6 febrero**        | **18:00-20:00**  |
| | Jueves, 8 febrero        | 18:00-20:00  |
| **Semana VII**       | **Martes, 13 febrero**        | **18:00-20:00**  |
| | Jueves, 15 febrero        | 18:00-20:00  |
| **Examen Final** |  **Pendiente de fijar**        |  |
"
...
## Evaluación
La nota final estará compuesta por los siguientes instrumentos de evaluación:
...
| Pruebas de respuesta larga (desarrollo) | 20% |
| Realización de prácticas con ordenador  | 40% |
...
No se exige la asistencia de forma obligatoria, sin embargo, se espera que el alumno que asista a clase permanezca en ella de forma activa y se implique en la dinámica de la misma ya que se fomentará la participación.


### Diversidad e Inclusión

El objetivo es que todo el asistente se sienta cómodo durante el desarrollo de las clases. Si hay alguna forma de hacer que el curso sea más acogedor, por favor, no dudéis en plantearlo.
